...
3. Saisissez vos identifiants Snowflake dans la barre latérale de l'application :
   - Utilisateur
   - Mot de passe
   - Compte
   - Entrepôt
...
- **Graphiques vides** :
  - Connectez-vous à Snowflake et vérifiez les tables :
    ```sql
    SELECT * FROM LINKEDIN.PUBLIC.top_jobs_by_industry LIMIT 10;
